...
public class NPC extends LevelElement {
  ...
  /**
   * Helper method used to determine the position of a Platform in an ArrayList<Platform> based on a
   * given position.
   * 
   * @param platforms
   ...
   * @return The index of a certain Platform in an ArrayList
   */
  ...
  /**
   * Returns an ArrayList of platform objects with the same height.
   * 
   * @param platforms
   *          An ArrayList of platform objects
   * @param height
   *          The y coordinate of platform objects
   * @return An ArrayList of platform objects with the same height
   */
  ...
  /**
   * Returns a vector array with the left and right boundaries of the underlying floor.
   * 
   * @param platformsIn
   *          An ArrayList of Platforms
   * @return A Vector array with the left and right boundaries of the underlying floor
   */
  ...
  /**
   * Returns a vector array with the left and right obstacle boundaries.
   * 
   * @param platformsIn
   *          An ArrayList of Platforms
   * @return A Vector array with the left and right obstacle boundaries
   */
  ...
  /**
   * Returns a vector array with the left and right coordinates of free horizontal movement space.
   * 
   * @param platforms
   *          An ArrayList of Platforms
   * @return A Vector array with left and right coordinates of free horizontal movement space.
   */
